export class NavMenu extends HTMLElement{
        ...
        connectedCallback() {
          var  carCount= this.attributes.carrito.value;
            ...
            <nav>
                <div class="nav-container">
                    ...
                    <ul class="links-container">               
                        ...
                        <div  class="cart-count" onclick="abrirModal()" style="display:none;">  
                          <img src="/img/cart-regular-24.png">
          ...
          this.shadowRoot.querySelector('.cart-count').style.display = carCount;
